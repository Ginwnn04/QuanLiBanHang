...
namespace QuanLiBanHang
{
    public partial class BanHangFrm : Form
    {
        ...
        {
            DialogResult dr = MessageBox.Show(" ?", "Xác nhận", MessageBoxButtons.YesNo, MessageBoxIcon.Information);
        ...
        public long writeDataInvoice()
        {
            ...
            invoice.employee_id = NhanVien.nhanVienLogin.id;
            invoice.customer_id = khachHang.id;
            invoice.total = total;
        ...
        private void btnKiemTra_Click(object sender, EventArgs e)
        {
            ...
            if (kiemTraKhachHang(txtSDT.Text) == null)
            {
        ...
        public KhachHang kiemTraKhachHang(String phone)
        {
            SqlConnection con = ConnectDB.getConnect();
            if (!ConnectDB.open())
            {
            ...
            string query = "SELECT * FROM tb_customers WHERE phone = @phone";
            SqlCommand cmd = new SqlCommand(query, con);
